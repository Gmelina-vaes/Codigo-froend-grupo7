...
// hacer una funcion que muestre los elementos, no su nombre
// de propiedades
////hacer una funcion que muestre solo los valores de cada elemento ,
// [no sus nombres(pripiedades)]
...
for (let elemento in objeto) {
  if (objeto.hasOwnProperty(elemento)) {
    resultado += `${objeto}.${elemento} = ${objeto[elemento]} \n`;
  }
}
return resultado;
}
...
let mechitabez= new carro("Mechita Benz","el ultimo",2077)
mechitabez.anio
mechitabez.marca
mechitabez.modelo
