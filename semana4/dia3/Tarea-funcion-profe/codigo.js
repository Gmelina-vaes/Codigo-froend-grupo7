// const   constante solo lo uso unavez
// let  usar  varias veces
...
switch(eleccion){
    case "mr-tambourine":
        titulo.textContent = contenido;
        parrafo.textContent = ` Hey, Mr. Tambourine Man, play a song for me
        I'm not sleepy and there is no place Im going tonHey, Mr. Tambourine Man, play a song for me
        In the jingle jangle morning I'll come following you Though I know that evening's empire has returned into sand
      following you`;
    case "i-want-to-break-free":
        titulo.textContent = contenido;
        parrafo.textContent = ` Hey, Mr. Tambourine Man, play a song for me
        I'm not sleepy and there is no place Im going to Hey, Mr. Tambourine Man, play a song for me
      o stand, but still not sleeping
        My weariness amazes me, I'm branded on my feet …`
    break
    case "movement":
        titulo.textContent = contenido;
    ...
    break
    case "cervecero":
    ctitulo.textContent = contenido;
    parrafo.textContent = `Cervecero yo soy y mi vida se va acabando
    En tragos, en noches y copas de licor Desesperado vivo en las cantinas
+o Pónganme mis tragosen las…`
     
        break;
        default:
            console.log("no hay ninguna musica");
}
